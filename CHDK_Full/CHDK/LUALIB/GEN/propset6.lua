...
return {
  ...
  VIDEO_FRAMERATE=167,        -- 1=25, 0=30 (elph130), may crash if doesn't match what canon uses for current resolution
  VIDEO_RESOLUTION=170,        -- 4=1280x720, 2=640x480 (elph130)
