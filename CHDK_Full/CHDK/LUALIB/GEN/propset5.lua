...
return {
  ...
  ISO_MODE=149,
  METERING_MODE=157,
  VIDEO_FRAMERATE=168,        -- 1=25 0=30, miniature mode 9=5x 10=10x 11=20x (sx160)  may crash if doesn't match what canon uses for current resolution
  VIDEO_RESOLUTION=170,        -- 5=1920x1080, 4=1280x720, 2=640x480, 1=320x240 
