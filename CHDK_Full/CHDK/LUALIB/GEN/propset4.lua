...
return {
  ...
  VIDEO_FRAMERATE=168,     -- 0=30fps, 1=24fps, 2=240fps, 3=120fps; timelapse in miniature: 8=5x, 9=10x, 10=20x (SX220)
  VIDEO_RESOLUTION=171,     -- 1=240p, 2=480p, 4=720p, 5=1080p (SX220)
